# Support for Output Descriptors in Footprintcoin Core

Since Footprintcoin Core v0.17, there is support for Output Descriptors in the
...
on Footprintcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Footprintcoin Core wallets, a convenience function `combo` is
