...
The Footprintcoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Footprintcoin Core requires ZeroMQ API version 4.x or
...
using. Footprintcoind appends an up-counting sequence number to each
