...
### Footprintcoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Footprintcoin Core for Linux, Windows, and macOS:
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/Footprintcoin, ... but this will usually sort out itself
