Footprintcoin Core version 0.16.0 is now available from:
...
Footprintcoin Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Footprintcoin Core is now 4.8. No effort will be
...
- #482 `5c8e26d` Footprintcoin: Basic changes for v0.16 release (thrasher-)
